...
export const Services: React.FC<ServicesProps> = ({ onNavigate }) => {
  const pillars = [
    {
      number: '01',
      title: '24/7/365 Human-Led SOC Monitoring',
      subhead: 'Someone is watching when your office isn\'t.',
      desc: 'Your endpoints don\'t stop being targets when your staff goes home. Continuous security monitoring provides ongoing visibility into suspicious activity and helps reduce the window between an attack beginning and your organization knowing about it.',
    ...
    {
      number: '02',
      title: 'Underwriter Requirement and Audit Mapping',
      subhead: 'Know what your insurer is asking for. Then prove it.',
      desc: 'We map your security posture against the requirements in your commercial cyber insurance documentation. You get a clear picture of what you\'re expected to have in place, what you already have, and where the gaps are.',
      objective: 'The objective: help you meet the requirements you\'re actually being asked to satisfy, and maintain the evidence to back it up when it matters. So there are no surprises at renewal.',
      icon: FileSearch,
      image: '/images/service_audit_grid.jpg',
    },
    {
      number: '03',
      title: 'Network and Cloud Insulation',
      subhead: 'Your attack surface doesn\'t stop at the office.',
      desc: 'We address security across physical workstations and critical cloud environments, including enterprise Google Workspace and Microsoft 365 environments. Because protecting the laptop in your office means little if an attacker can simply walk through another door.',
      objective: 'The objective: strengthen the layers surrounding the systems and information your practice depends on.',
      icon: Network,
